...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/fashiongen_data.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='data/fashiongen.json', help='output json file')
  parser.add_argument('--output_pkl', default='data/fashiongen-val', help='output pickle file')
  parser.add_argument('--split', default='val', help='test, val, train, all')
