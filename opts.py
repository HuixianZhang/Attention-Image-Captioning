...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='data/fashiongen.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='/media/alissa/f057ed4c-8805-4e15-9203-c2fecc0b63b0/fashion_attention/data/fashiongen_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/media/alissa/f057ed4c-8805-4e15-9203-c2fecc0b63b0/fashion_attention/data/fashiongen_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='data/fashiongen_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='data/fashiongen_label.h5',
    ...
    parser.add_argument('--start_from', type=str, default= 'None',
                    ...
                    """)
    parser.add_argument('--cached_tokens', type=str, default='fashiongen-train-idxs',
